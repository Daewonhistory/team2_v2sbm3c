...
public class EmailTool {
  ...
  @Autowired
  @Qualifier("dev.mvc.emailAuth.EmailAuthProc")
  private EmailAuthProInter emailProc;
  ...
  public CompletableFuture<Boolean> sendAuthenticationCode(String email) {
    logger.info("Starting sendAuthenticationCode for email: {}", email);
