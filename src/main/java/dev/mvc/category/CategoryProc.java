...
public class CategoryProc implements CategoryProcInter {
  ...
  public int delete(int categoryno) {
    return this.categoryDAO.delete(categoryno);
  }


  @Override
  public int multiple_delete(List<Integer> categoryno) {
    return this.categoryDAO.multiple_delete(categoryno);
  }

  @Override
  public int min(int categoryno) {
    return this.categoryDAO.min(categoryno);
  }


  @Override
  public int max(int categoryno) {
    return this.categoryDAO.max(categoryno);
  }

  @Override
  public int update_forward(int categoryno) {
    return this.categoryDAO.update_forward(categoryno);
  }

  @Override
  public int update_backward(int categoryno) {
    return this.categoryDAO.update_backward(categoryno);
  }

  @Override
  public int show(int categoryno) {
    return this.categoryDAO.show(categoryno);
  }

  @Override
  public int hide(int categoryno) {
    return this.categoryDAO.hide(categoryno);
  }

  @Override
  public ArrayList<CategoryVO> list_all_name_y() {
    return this.categoryDAO.list_all_name_y();
  }

  @Override
  public ArrayList<CategoryVO> list_namesub_y(String name) {
    return this.categoryDAO.list_namesub_y(name);
  }

  @Override
  public ArrayList<CategoryVO> list_namesub() {
    return this.categoryDAO.list_namesub();
  }
  ...
  public ArrayList<CateVOMenu> menu() {
    ...
    for (CategoryVO categoryVO : list) {
      CateVOMenu categoryVOMenu = new CateVOMenu();
      categoryVOMenu.setName(categoryVO.getName());

      ArrayList<CategoryVO> list_namesub = this.categoryDAO.list_namesub_y(categoryVO.getName());
      categoryVOMenu.setListnamesub(list_namesub);
  ...
  @Override
  public ArrayList<CategoryVO> list_search_paging(String word, String type, int now_page, int record_per_page) {
  ...
  public int list_search_count(String word, String type) {
    ...
    int count = this.categoryDAO.list_search_count(search);
    return count;
  }
